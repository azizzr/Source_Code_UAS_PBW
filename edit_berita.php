...
$ambil = mysqli_query($koneksi, "SELECT * FROM berita WHERE id_menu='$id_menu'");
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="edit.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Minuman" name="jenis_menu">Kerajinan
            </label>
          </div>
         </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="harga1">Pengirim</label>
