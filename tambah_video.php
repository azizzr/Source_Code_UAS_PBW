...
<html lang="en">
 ...
 <!-- Form Registrasi -->
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Makanan" name="jenis_menu" checked>Kerajinan 
            </label>
          </div>
         </div>
        <div class="form-group">
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO berita VALUES (NULL, '$nama', '$jenis', '$stok', '$harga', '$nama_file')");

    if($insert){
      header("location: isi_video.php");
    }
    else {
